...
<head>
	...
	<link rel="stylesheet" href="css/pago2.css">
...
<body>
	...
	<div class="contenido">
		...
		<div class="nreserva2">
		<form name="procesa" action="procesa-pagos.php" method="post" target="_blank" onsubmit="return validaTarjeta()">
		<h4>¡Su reserva no ha sido pagada!</h4>
		<p id="txt">Por favor haga el pago a continuación para poder realizar el Check-in </p>
		<p>Nro De Reserva: <input type="text" name="reserva" id="reserva" value=""></p>
		<p>
		...
		<p id="volver"><a href="checkin.php">Volver al Check-in</p>
	<div class="pie">
